...
We delete all the @register_dataset decorators.
The other modifications are marked with "Noted: Modification here.".
...
from det3.dataloader.carladata import CarlaCalib, CarlaLabel, CarlaObj
...
class NuScenesDataset(Dataset):
    ...
    def ground_truth_annotations(self):
        ...
        cfg = config_factory("detection_"+self.eval_version)
    ...
    def __getitem__(self, idx):
        ...
        input_dict = self._to_carlaloader(input_dict)
    ...
    Note: Modification here
    '''
    def _to_carlaloader(self, input_dict):
        '''
        @info_dict:
        {
            "lidar": {
        ...
        res["lidar"]["points"] = {"velo_top": input_dict["lidar"]["points"]}
        res["metadata"]["tag"] = input_dict["metadata"]["token"]
        res["metadata"]["token"] = input_dict["metadata"]["token"]
        calib = CarlaCalib(None)
