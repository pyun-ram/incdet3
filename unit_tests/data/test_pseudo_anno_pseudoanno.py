...
cfg.TRAINDATA = {
    ...
    "@root_path": "/usr/app/incdet3/unit_tests/data/test_kittidata/training",
    "@info_path": "/usr/app/incdet3/unit_tests/data/test_kittidata/KITTI_infos_train.pkl",
...
cfg.VALDATA = {
    ...
    "num_workers": 5,
    "feature_map_size": [1, 160, 132],
    "@root_path": "unit_tests/data/test_kittidata/training",
...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "unit_tests/data/test_pseudo_anno_nopseudoanno_weight_train_class2-23200.tckpt",
        "num_classes": 2,
