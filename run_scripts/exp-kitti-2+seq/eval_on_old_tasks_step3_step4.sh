...
## EWC
CUDA_VISIBLE_DEVICES=$1 python3 main.py \
    --tag 20210110-expkitti2+seq-B3ewcold-eval \
    --cfg-path configs/exp-kitti-2+seq/B3ewcold-eval.py \
    --mode test

CUDA_VISIBLE_DEVICES=$1 python3 main.py \
    --tag 20210110-expkitti2+seq-B4ewcold-eval \
    --cfg-path configs/exp-kitti-2+seq/B4ewcold-eval.py \
    --mode test
## MAS
CUDA_VISIBLE_DEVICES=$1 python3 main.py \
    --tag 20210110-expkitti2+seq-B3masold-eval \
    --cfg-path configs/exp-kitti-2+seq/B3masold-eval.py \
    --mode test

CUDA_VISIBLE_DEVICES=$1 python3 main.py \
    --tag 20210110-expkitti2+seq-B4masold-eval \
...
## IncDet
CUDA_VISIBLE_DEVICES=$1 python3 main.py \
    --tag 20210110-expkitti2+seq-B3pseudoewcold-eval \
    --cfg-path configs/exp-kitti-2+seq/B3pseudoewcold-eval.py \
    --mode test

CUDA_VISIBLE_DEVICES=$1 python3 main.py \
    --tag 20210110-expkitti2+seq-B4pseudoewcold-eval \
