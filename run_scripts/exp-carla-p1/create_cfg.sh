...
#     --template-cfg-path configs/exp-carla-p1/finetuning_cv0.py \
#     --save-path configs/exp-carla-p1/finetuning_cv$i.py \
#     --key-pairs CARLA_infos_train0.pkl=CARLA_infos_train$i.pkl,CARLA_infos_val0.pkl=CARLA_infos_val$i.pkl

# python3 tools/create_config_files.py \
#     --template-cfg-path configs/exp-carla-p1/lwf_distloss_cv0.py \
#     --save-path configs/exp-carla-p1/lwf_distloss_cv$i.py \
#     --key-pairs CARLA_infos_train0.pkl=CARLA_infos_train$i.pkl,CARLA_infos_val0.pkl=CARLA_infos_val$i.pkl

# python3 tools/create_config_files.py \
#     --template-cfg-path configs/exp-carla-p1/jointtraining_cv0.py \
#     --save-path configs/exp-carla-p1/jointtraining_cv$i.py \
#     --key-pairs CARLA_infos_train0.pkl=CARLA_infos_train$i.pkl,CARLA_infos_val0.pkl=CARLA_infos_val$i.pkl
