...
cfg.TRAINDATA = {
    ...
    "@info_path": "/usr/app/data/CARLA-P1-TASK3/CARLA_infos_train1.pkl",
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-P1-TASK3/training/",
    "@info_path": "/usr/app/data/CARLA-P1-TASK3/CARLA_infos_val1.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/incdet-saveweights/IncDetExpCARLAP1+-lwf-cv1-noreuse-bias-32-20000.tckpt",
        "num_classes": 2,
