...
cfg.TRAINDATA = {
    ...
    "@root_path": "/usr/app/data/CARLA-P2-TASK2/training/",
    "@info_path": "/usr/app/data/CARLA-P2-TASK2/CARLA_infos_train1.pkl",
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-P2-TASK2/training/",
    "@info_path": "/usr/app/data/CARLA-P2-TASK2/CARLA_infos_val1.pkl",
...
cfg.TESTDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-P2-TASK2/training/",
    "@info_path": "/usr/app/data/CARLA-P2-TASK2/CARLA_infos_test.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.NETWORK = {
    ...
    "@classes_source": ["Car"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/incdet-saveweights/IncDetCarExpCARLAP2-15000.tckpt",
        "num_classes": 1,
