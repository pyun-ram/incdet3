...
cfg.TRAINDATA = {
    ...
    "@info_path": "/usr/app/data/CARLA-P2-TASK3/CARLA_infos_train1.pkl",
    "@class_names": ["Cyclist"],
    "prep": {
        "@training": True,
        "@augment_dict":
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-P2-TASK3/training/",
    "@info_path": "/usr/app/data/CARLA-P2-TASK3/CARLA_infos_val1.pkl",
...
cfg.NETWORK = {
    ...
    "@classes_source": None,
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/incdet-saveweights/IncDetExpCARLAP2-finetune-cv1-20000.tckpt",
        "num_classes": 2,
