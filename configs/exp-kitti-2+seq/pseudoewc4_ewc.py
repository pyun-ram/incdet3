...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20200923-expkitti2+seq-weights/ewc_class4-TBDstepsTBD.tckpt",
        "num_classes": 4,
...
cfg.EWC = {
    ...
    "oldtask_FIM_paths": [
        ...
        "saved_weights/20200923-ewcweights-kitti2+seq-pseudoewc3/ewc_weights-TBDstepsTBD.pkl"
    ],
