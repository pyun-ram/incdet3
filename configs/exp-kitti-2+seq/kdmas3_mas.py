...
cfg.NETWORK = {
    ...
    "@ewc_weights_path": "saved_weights/20200905-ewcweights-compute_clsterm_regterm/ewc_weights-23200-0.1.pkl",
...
cfg.MAS = {
    "@num_of_anchorsamples": 128,
    "@anchor_sample_strategy": "biased",
    "@reg_coef": 1,
    "@oldtask_omega_paths": ["saved_weights/20201007-masweights-class2/mas_omega-23200.pkl"],
    "@oldtask_omega_weights": [1.0],
