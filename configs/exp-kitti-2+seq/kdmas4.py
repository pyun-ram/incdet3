...
cfg.TRAIN = {
    ...
    "num_log_iter": 40,
    "num_val_iter": int(715/8 * 5),
    "num_save_iter": int(715/8 * 5),
    "optimizer_dict":{
        "type": "adam",
        "init_lr": 1e-3,
        "weight_decay": 0,
...
cfg.TRAINDATA = {
    ...
    "prep": {
        ...
        "@classes_to_exclude": ["Car", "Pedestrian", "Cyclist"]
    },
    "prep_infos": {
...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20201008-expkitti2+seq-weights/kdmas_class3-27946.tckpt",
        "num_classes": 3,
    ...
    "@ewc_coef": 100,
    "@ewc_weights_path": "saved_weights/20201008-masweights-kitti2+seq-kdmas3/mas_omega-27946.pkl",
