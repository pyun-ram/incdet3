...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20200913-expkitti2+seq-weights/kdewc_class4-36126.tckpt",
        "num_classes": 4,
    ...
    "@ewc_weights_path": "saved_weights/20200913-ewcweights-kitti2+seq-kdewc4/ewc_weights-36126-reg2coef1-clsregcoef1.pkl",
