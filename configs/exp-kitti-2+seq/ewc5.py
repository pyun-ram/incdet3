...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20200913-expkitti2+seq-weights/ewc_class4-36572.tckpt",
        "num_classes": 4,
    ...
    "@ewc_weights_path": "saved_weights/20200913-ewcweights-kitti2+seq-ewc4/ewc_weights-36572-reg2coef1-clsregcoef1.pkl",
