...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20200925-expkitti2+seq-weights/ewc_class4-TBDstepsTBD.tckpt",
        "num_classes": 4,
    ...
    "@ewc_weights_path": "saved_weights/20200925-ewcweights-kitti2+seq-ewc4/ewc_weights-TBDstepsTBD.pkl",
