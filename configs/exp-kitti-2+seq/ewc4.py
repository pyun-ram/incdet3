...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20200921-expkitti2+seq-weights/ewc_class3-29202.tckpt",
        "num_classes": 3,
    ...
    "@ewc_weights_path": "saved_weights/20200921-ewcweights-kitti2+seq-ewc3/ewc_weights-29202.pkl",
