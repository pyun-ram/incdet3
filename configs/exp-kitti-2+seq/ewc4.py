...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20200913-expkitti2+seq-weights/ewc_class3-TBDstepTBD.tckpt",
        "num_classes": 3,
    ...
    "@ewc_weights_path": "saved_weights/20200913-ewcweights-kitti2+seq-ewc3/ewc_weights-TBDstepTBD-0.1.pkl",
