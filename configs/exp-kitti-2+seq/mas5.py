...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20201008-expkitti2+seq-weights/ewc_class4-TBDstepsTBD.tckpt",
        "num_classes": 4,
    ...
    "@ewc_coef": 100,
    "@ewc_weights_path": "saved_weights/20201008-masweights-kitti2+seq-mas4/mas_omega-TBDstepsTBD.pkl",
