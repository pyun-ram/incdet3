...
cfg.TRAIN = {
    ...
    "num_log_iter": 40,
    "num_val_iter": int(387/8 * 5),
    "num_save_iter": int(387/8 * 5),
    "optimizer_dict":{
        "type": "adam",
        "init_lr": 1e-3,
        "weight_decay": 0,
...
cfg.TRAINDATA = {
    ...
    "prep": {
        ...
        "@classes_to_exclude": ["Car", "Pedestrian", "Cyclist", "Van"]
    },
    "prep_infos": {
...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20201008-expkitti2+seq-weights/kdmas_class4-34342.tckpt",
        "num_classes": 4,
    ...
    "@ewc_coef": 100,
    "@ewc_weights_path": "saved_weights/20201008-masweights-kitti2+seq-kdmas4/mas_omega-34342.pkl",
    "@ewc_loss_type": "l2", # "l2", "huber"
    "@ewc_huberloss_beta": 1e-3,
