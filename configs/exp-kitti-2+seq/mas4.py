...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20201008-expkitti2+seq-weights/mas_class3-27632.tckpt",
        "num_classes": 3,
    ...
    "@ewc_coef": 100,
    "@ewc_weights_path": "saved_weights/20201008-masweights-kitti2+seq-mas3/mas_omega-27632.pkl",
