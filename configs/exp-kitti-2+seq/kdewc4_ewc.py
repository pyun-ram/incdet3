...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20200921-expkitti2+seq-weights/kdewc_class4-TBDstepsTBD.tckpt",
        "num_classes": 4,
...
cfg.EWC = {
    ...
    "oldtask_FIM_paths": [
        ...
        "saved_weights/20200919-ewcweights-kitti2+seq-kdewc3/ewc_weights-TBDstepsTBD.pkl"],
