...
cfg.TARGETASSIGNER = {
    "type": "TaskAssignerV1",
    "@classes": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle", "motorcycle", "bicycle"],
...
cfg.TRAINDATA = {
    ...
    "prep": {
        ...
        "@classes_to_exclude": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle", "motorcycle"]
    }
}
...
cfg.NETWORK = {
    "@classes_target": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle", "motorcycle", "bicycle"],
    "@classes_source": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle", "motorcycle"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/July22-expnusc-5+seq-lwf-8/IncDetMain-95000.tckpt",
        "num_classes": 8,
        "num_anchor_per_loc": 16,
