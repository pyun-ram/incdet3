...
cfg.TARGETASSIGNER = {
    "type": "TaskAssignerV1",
    "@classes": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle", "motorcycle"],
...
cfg.TRAINDATA = {
    ...
    "prep": {
        ...
        "@classes_to_exclude": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle"]
    }
}
...
cfg.NETWORK = {
    "@classes_target": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle", "motorcycle"],
    "@classes_source": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/July22-expnusc-5+seq-lwf-7/IncDetMain-80000.tckpt",
        "num_classes": 7,
        "num_anchor_per_loc": 14,
