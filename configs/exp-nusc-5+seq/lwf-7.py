...
cfg.TARGETASSIGNER = {
    "type": "TaskAssignerV1",
    "@classes": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle"],
...
cfg.TRAINDATA = {
    ...
    "prep": {
        ...
        "@classes_to_exclude": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer"]
    }
}
...
cfg.NETWORK = {
    "@classes_target": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer", "construction_vehicle"],
    "@classes_source": ["car", "pedestrian", "barrier", "truck", "traffic_cone", "trailer"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/July22-expnusc-5+seq-lwf-6/IncDetMain-65000.tckpt",
        "num_classes": 6,
