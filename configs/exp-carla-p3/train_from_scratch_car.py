...
cfg.TRAINDATA = {
    ...
    "@root_path": "/usr/app/data/CARLA-P3-TASK1/training/",
    "@info_path": "/usr/app/data/CARLA-P3-TASK1/CARLA_infos_train.pkl",
    "@class_names": ["Car"],
    "prep": {
        "@training": True,
        "@augment_dict":
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-P3-TASK1/training/",
    "@info_path": "/usr/app/data/CARLA-P3-TASK1/CARLA_infos_val.pkl",
...
cfg.TESTDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-P3-TASK1/training/",
    "@info_path": "/usr/app/data/CARLA-P3-TASK1/CARLA_infos_test.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
