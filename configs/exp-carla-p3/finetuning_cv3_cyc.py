...
cfg.TRAINDATA = {
    ...
    "@info_path": "/usr/app/data/CARLA-P3-TASK3/CARLA_infos_train3.pkl",
    "@class_names": ["Cyclist"],
    "prep": {
        "@training": True,
        "@augment_dict":
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-P3-TASK3/training/",
    "@info_path": "/usr/app/data/CARLA-P3-TASK3/CARLA_infos_val3.pkl",
...
cfg.NETWORK = {
    ...
    "@classes_source": None,
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/incdet-saveweights/IncDetExpCARLAP3-finetune-cv3-20000.tckpt",
        "num_classes": 2,
