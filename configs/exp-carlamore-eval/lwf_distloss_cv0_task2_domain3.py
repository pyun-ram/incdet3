...
cfg.TRAINDATA = {
    ...
    "@root_path": "/usr/app/data/CARLA-TOWN02CARPED/training/",
    "@info_path": "/usr/app/data/CARLA-TOWN02CARPED/CARLA_infos_train0.pkl",
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-TOWN02CARPED/training/",
    "@info_path": "/usr/app/data/CARLA-TOWN02CARPED/CARLA_infos_val0.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.TESTDATA = {
    ...
    "num_workers": 1,
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-TOWN01CARPEDCYC/training/",
    "@info_path": "/usr/app/data/CARLA-TOWN01CARPEDCYC/CARLA_infos_test.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.NETWORK = {
    ...
    "@classes_source": ["Car"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/July07-expcarla-il/July07-expcarla-lwf-cv0/IncDetMain-20000.tckpt",
        "num_classes": 1,
    ...
    "@sub_model_resume_dict": {
        "ckpt_path": "saved_weights/incdet-saveweights/IncDetCarExpCARLA-15000.tckpt",
        "num_classes": 1,
        "num_anchor_per_loc": 2,
        "partially_load_params": [],
        "ignore_params": []
