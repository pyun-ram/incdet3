...
cfg.TRAINDATA = {
    ...
    "@root_path": "/usr/app/data/CARLA_EPISODE2_CARPED/training/",
    "@info_path": "/usr/app/data/CARLA_EPISODE2_CARPED/CARLA_infos_train_2.pkl",
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA_EPISODE2_CARPED/training/",
    "@info_path": "/usr/app/data/CARLA_EPISODE2_CARPED/CARLA_infos_val_2.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.TESTDATA = {
    ...
    "num_workers": 1,
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA_EPISODE1_CAR/training/",
    "@info_path": "/usr/app/data/CARLA_EPISODE1_CAR/CARLA_infos_test.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.NETWORK = {
    ...
    "@classes_source": ["Car"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/incdet3-carlasmall-July4/July04-expcarlasmall-lwf-cv2/IncDetMain-4000.tckpt",
        "num_classes": 1,
    ...
    "@sub_model_resume_dict": {
        "ckpt_path": "saved_weights/incdet-saveweights/IncDetCarExpCARLASmall-2000.tckpt",
        "num_classes": 1,
        "num_anchor_per_loc": 2,
        "partially_load_params": [],
        "ignore_params": []
