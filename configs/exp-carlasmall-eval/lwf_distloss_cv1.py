...
cfg.TRAINDATA = {
    ...
    "@info_path": "/usr/app/data/CARLA_EPISODE2_CARPED/CARLA_infos_train_1.pkl",
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA_EPISODE2_CARPED/training/",
    "@info_path": "/usr/app/data/CARLA_EPISODE2_CARPED/CARLA_infos_val_1.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.NETWORK = {
    ...
    "@classes_source": ["Car"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/incdet3-carlasmall-July4/July04-expcarlasmall-lwf-cv1/IncDetMain-3800.tckpt",
        "num_classes": 1,
