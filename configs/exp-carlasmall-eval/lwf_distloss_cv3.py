...
cfg.TRAINDATA = {
    ...
    "@info_path": "/usr/app/data/CARLA_EPISODE2_CARPED/CARLA_infos_train_3.pkl",
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA_EPISODE2_CARPED/training/",
    "@info_path": "/usr/app/data/CARLA_EPISODE2_CARPED/CARLA_infos_val_3.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.NETWORK = {
    ...
    "@classes_source": ["Car"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/incdet3-carlasmall-July4/July04-expcarlasmall-lwf-cv3/IncDetMain-2400.tckpt",
        "num_classes": 1,
