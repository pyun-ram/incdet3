...
cfg.TASK = {
    "valid_range": [-50.4, -51.2, -5, 50.4, 51.2, 3],
...
cfg.TRAINDATA = {
    ...
    "batch_size": 5,
    "num_workers": 10,
    "feature_map_size": [1, 128, 126],
    "@root_path": "/usr/app/data/Nuscenes-Mini/",
    "@info_path": "/usr/app/data/Nuscenes-Mini/infos_train.pkl",
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 128, 126],
    "@root_path": "/usr/app/data/Nuscenes-Mini/",
    "@info_path": "/usr/app/data/Nuscenes-Mini/infos_val.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.NETWORK = {
    ...
    "@classes_source": None,
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/pretrain_weights/KITTIRESUME.pkl",
        "num_classes": 1,
