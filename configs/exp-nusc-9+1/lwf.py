...
cfg.TRAINDATA = {
    ...
    "prep": {
        ...
        "trailer", "construction_vehicle", "motorcycle", "bicycle"]
    }
}
...
cfg.NETWORK = {
    "@classes_target": ["car", "pedestrian", "barrier", "truck", "traffic_cone",
        "trailer", "construction_vehicle", "motorcycle", "bicycle", "bus"],
    "@classes_source": ["car", "pedestrian", "barrier", "truck", "traffic_cone",
        "trailer", "construction_vehicle", "motorcycle", "bicycle"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/July22-expnusc-9+1-train_from_scratch/IncDetMain-50000.tckpt",
        "num_classes": 9,
