...
cfg.TRAINDATA = {
    ...
    "@info_path": "/usr/app/data/CARLA-TOWN02CARPED/CARLA_infos_train4.pkl",
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-TOWN02CARPED/training/",
    "@info_path": "/usr/app/data/CARLA-TOWN02CARPED/CARLA_infos_val4.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.NETWORK = {
    ...
    "@classes_source": ["Car"],
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/July07-expcarla-il/July07-expcarla-lwf-cv4/IncDetMain-18000.tckpt",
        "num_classes": 1,
