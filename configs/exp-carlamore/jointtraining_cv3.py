...
cfg.TRAINDATA = {
    ...
    "@info_path": "/usr/app/data/CARLA-TOWN01CARPEDCYC/CARLA_infos_train3.pkl",
...
cfg.VALDATA = {
    ...
    "feature_map_size": [1, 200, 176],
    "@root_path": "/usr/app/data/CARLA-TOWN01CARPEDCYC/training/",
    "@info_path": "/usr/app/data/CARLA-TOWN01CARPEDCYC/CARLA_infos_val3.pkl",
    "@class_names": cfg.TARGETASSIGNER["@classes"].copy(),
    "prep": {
        "@training": False,
        "@augment_dict": None,
...
cfg.NETWORK = {
    ...
    "@classes_source": None,
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/incdet-saveweights/IncDetCarExpCARLAMore-jointtrain-cv3-20000.tckpt",
        "num_classes": 2,
