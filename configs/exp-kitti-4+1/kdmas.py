...
cfg.NETWORK = {
    ...
    "@model_resume_dict": {
        "ckpt_path": "saved_weights/20200812-expkitti4+1-saved_weights/train_class4-23200.tckpt",
        "num_classes": 4,
    ...
    "@ewc_coef": 100,
    "@ewc_weights_path": "saved_weights/20201008-masweights-class4/mas_omega-23200.pkl",
